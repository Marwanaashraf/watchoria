...
import { getRatings } from "../../../Redux/RatingSlice.js";
  ...
  return (
    <div className="border border-slate-300 dark:border-slate-800 rounded-md p-3 my-8">
      ...
      <div className="flex items-center justify-between">
        ...
        >
          ...
          <div className="flex gap-1 items-center">
            <h2 className="text-xl md:text-3xl font-medium">Ratings</h2>
      ...
      <div className="w-[85%] lg:w-[94%] mx-auto my-7 relative ">
              ...
              <SwiperSlide className="h-auto">
                ...
                >
                  ...
                  <div className="flex flex-col justify-between items-center flex-1 p-2 bg-slate-200 dark:bg-slate-900 rounded-b-lg py-2">
                    ...
                    {/* ratings */}
                    <div className="flex gap-3 items-center justify-center mt-2 text-lg">
                      <div className="space-x-1">
                        <i className="fa-solid fa-star text-yellow-500 " />
                        <span>{ele.show_rating?.toFixed(1)}</span>
                      </div>
                      <div className="space-x-1.5">
                        <i className="fa-solid fa-star text-secondry" />
                        <span>{ele.rating_vote}</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <NavBtn
          className="rating-prev absolute top-1/2 -left-10"
          iconDir="left"
        />
        <NavBtn
          className="rating-next absolute top-1/2 -right-10"
          iconDir="right"
        />
      </div>
    </div>
