...
export default function Footer() {
  ...
  return (
    <footer className=" bg-slate-200 dark:bg-slate-900 p-3 py-5">
      <div className="contain grid grid-cols-1 md:grid-cols-3  gap-5">
        <div className="space-y-2">
          <div className="flex space-x-1 items-center cursor-pointer">
            ...
            <NavLink
              to="/"
              className="text-2xl font-sans text-main uppercase font-bold "
            >
              Watchoria
            </NavLink>
          </div>
        ...
        <div className="space-y-2">
          ...
          <div
            onClick={tvDropDown}
            className="flex justify-between items-center  hover:text-main cursor-pointer"
          >
            <h5 className="font-semibold text-lg cursor-pointer hover:text-main">
              TvShows
            </h5>
