      ...
      <div className="flex space-x-1">
        ...
        <div className="relative">
          <input
            ...
            onChange={searchAll}
            onKeyDown={(e) => {
              if (e.key === "Enter" && val.trim("")) handleClick();
            }}
            className="p-2 w-72 sm:w-96 lg:w-64 xl:w-96 text-slate-900 dark:text-slate-300 bg-transparent rounded-lg border-slate-400 dark:border-white  border focus:border-main  focus:dark:border-main focus:outline-none placeholder:text-slate-700 placeholder:dark:text-slate-400"
            type="text"
            placeholder="Search..."
            value={val}
          />
